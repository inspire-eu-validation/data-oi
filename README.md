...
The Data Specification on Orthoimagery – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Orthoimagery.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-gml) | INSPIRE spatial data set encoded in GML, Orthoimagery features |
| [Application Schema, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-as) | INSPIRE spatial data set |
| [Reference Systems, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-rs) | INSPIRE spatial data set |
| [Data Consistency, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-dc) | INSPIRE spatial data set |
| [Information Accessibility, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-ia) | INSPIRE spatial data set |
| [Portrayal, Orthoimagery](http://inspire.ec.europa.eu/id/ats/data-oi/3.0/oi-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Orthoimagery - Core", are not needed as no feature instance can be of a type from that application schema.
