...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/oi/4.0/Orthoimagery.xsd, using strict XML schema validation.
